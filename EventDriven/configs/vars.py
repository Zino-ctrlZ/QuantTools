...
CONFIG_DEFINITIONS = {
    ...
    "PnlMonitorConfig": {
        ...
        "stop_loss_cash_threshold": "Computed property in this class; optional cash-based stop-loss threshold.",
        "max_trade_dollar_size": "Computed property in this class; optional cap on per-trade dollar sizing.",
        "profit_lock_in_lvl": "Computed property in this class; controls lock-in mode (1=tick cash only, 2=tick cash and max trade dollar size).",
    },
    "PnLMonitorConfigConfigurable": {
        ...
        "stop_loss_pct": "Directly configurable percent loss threshold for exits; set to None when using cash stop-loss mode.",
