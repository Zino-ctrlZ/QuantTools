...
class BaseCog:
    ...
    def on_new_order_request(self, new_request_state: OrderRequest) -> OrderRequest:
        ...
        Subclasses can override this to modify the order request before it is processed.
        By default, it returns the input unmodified.
         - This allows cogs to inject additional logic at the order request stage,
           such as adjusting order parameters, adding risk checks, or logging.
         - The method receives the new_request_state generated by the signal or position logic.
         - Cogs can choose to modify this request (e.g., change quantity, price, etc.) or leave it as is.
         - After all cogs have had a chance to process the request, the final (potentially modified) new_request_state is returned and will be used by the Order Picker.
         - This provides a powerful extension point for cogs to influence order generation without needing to modify the core signal or position logic.
        """
