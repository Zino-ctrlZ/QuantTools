...
class RiskManager:
    ...
    def __init__(self,
                 ...
                 executor: ExecutionHandler=None,
                 unadjusted_signals: pd.DataFrame=pd.DataFrame(),
                 *args,
    ...
    def get_order(self, req: OrderRequest) -> NewPositionState:
        ...
        ## Create NewPositionState and run through analyzer
