...
class OptionSignalStrategy(Strategy):
    ...
    def __init__(self, bars, events):
        ...
        self.events = events
        self.symbol_list = self.bars.symbol_list
        self.logger = setup_logger("EventDriven.strategy")
    ...
    def calculate_signals(self):
        ...
        0: Do nothing
        """
        self.__latest_signals = self.bars.get_latest_bars(
            ""
        )  # this returns a dataframe with the latest signals for each underlier
